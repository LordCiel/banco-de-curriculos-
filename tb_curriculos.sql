...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Set-2019 às 20:13
...
INSERT INTO `tb_admin` (`id_admin`, `login`, `senha`, `email`) VALUES
(1, 'gabriel', '43741236870', 'marketing@acijales.com.br');
...
INSERT INTO `tb_empresa` (`id_empresa`, `razao`, `senha`, `email`, `endereco`, `telefone`, `id_cidade`, `id_estado`) VALUES
(1, 'Associação Comercial e Industrial de Jales', 'acij2018', 'marketing@acijales.com.br', 'Avenida Francisco Jales 1540', 1736221540, 4989, 26),
(12, 'teste', '123456', 'teste@teste.com', 'Avenida Francisco Jales', 1234567890, 4989, 26);
...
INSERT INTO `tb_usuario` (`id_usuario`, `nome`, `senha`, `email`, `experiencia`, `endereco`, `sexo`, `dataNasc`, `formacao`, `telefone`, `id_cidade`, `id_estado`) VALUES
(1, 'Gabriel de Oliveira', '43741236870', 'gabrielnewgeek@gmail.com', 'Assistente de Marketing ACIJ', 'Rua Guido Parminonde 1797', 'Masculino', '1996-12-14', 'Ensino Superior', 17981327527, 4989, 26);
...
INSERT INTO `tb_vaga` (`id_vaga`, `nomeVaga`, `descricao`, `experiencia`, `salario`, `escolaridade`, `periodo`, `tipoContrato`, `id_empresa`) VALUES
(1, 'Teste ACIJ', 'TESTE', 'SIM', '00000', 'Ensino Superior', 'Integral', 'CLT', 1),
(5, 'teste2', 'teste2', 'teste2', 'teste2', 'teste2', 'teste2', 'teste2', 12);
...
ALTER TABLE `cidade`
  ...
  ADD KEY `estadocidade` (`id_estado`);
...
ALTER TABLE `tb_empresa`
  ...
  ADD UNIQUE KEY `email` (`email`),
  ADD KEY `empresacidade` (`id_cidade`),
  ADD KEY `empresaestado` (`id_estado`);
...
ALTER TABLE `tb_usuario`
  ...
  ADD UNIQUE KEY `email` (`email`),
  ADD KEY `usuariocidade` (`id_cidade`),
  ADD KEY `usuarioestado` (`id_estado`);
...
ALTER TABLE `tb_vaga`
  ...
  ADD KEY `empresavaga` (`id_empresa`);
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `estadocidade` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);

--
-- Limitadores para a tabela `tb_empresa`
--
ALTER TABLE `tb_empresa`
  ADD CONSTRAINT `empresacidade` FOREIGN KEY (`id_cidade`) REFERENCES `cidade` (`id_cidade`),
  ADD CONSTRAINT `empresaestado` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);

--
-- Limitadores para a tabela `tb_usuario`
--
ALTER TABLE `tb_usuario`
  ADD CONSTRAINT `usuariocidade` FOREIGN KEY (`id_cidade`) REFERENCES `cidade` (`id_cidade`),
  ADD CONSTRAINT `usuarioestado` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`);

--
-- Limitadores para a tabela `tb_vaga`
--
ALTER TABLE `tb_vaga`
  ADD CONSTRAINT `empresavaga` FOREIGN KEY (`id_empresa`) REFERENCES `tb_empresa` (`id_empresa`);
COMMIT;
